      ...
      <div style="padding:16px 20px;border-bottom:1px solid #e2e8f0;">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;">
          ...
          <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:7px;padding:10px 13px;">
            ...
            <select onchange="var t=getTasks().find(x=>x.id==='${task.id}');if(t)t.status=this.value;showToast('Status updated','success')" style="width:100%;padding:5px 8px;border:1.5px solid ${sc(task.status)}44;border-radius:5px;font-size:12px;font-weight:700;color:${sc(task.status)};background:${sc(task.status)}11;outline:none;cursor:pointer;">
